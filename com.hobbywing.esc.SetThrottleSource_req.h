...
static inline bool _com_hobbywing_esc_SetThrottleSourceRequest_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetThrottleSourceRequest* msg, bool tao);
...
/*
 decode com_hobbywing_esc_SetThrottleSourceRequest, return true on failure, false on success
*/
bool _com_hobbywing_esc_SetThrottleSourceRequest_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetThrottleSourceRequest* msg, bool tao) {
