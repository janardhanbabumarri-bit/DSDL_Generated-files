...
static inline bool _ardupilot_gnss_Heading_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct ardupilot_gnss_Heading* msg, bool tao);
...
/*
 decode ardupilot_gnss_Heading, return true on failure, false on success
*/
bool _ardupilot_gnss_Heading_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct ardupilot_gnss_Heading* msg, bool tao) {
